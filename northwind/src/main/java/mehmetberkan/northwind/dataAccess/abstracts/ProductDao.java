...
public interface ProductDao extends JpaRepository<Product,Integer>{
	...
	@Query("Select new mehmetberkan.northwind.entities.dtos.ProductWithCategoryDto(p.id, p.productName, c.categoryName) From Category c Inner Join c.products p")
